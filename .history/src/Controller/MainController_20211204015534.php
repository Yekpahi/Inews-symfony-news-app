...
class MainController extends AbstractController
{
     ...
     */
    public function details($slug, VideoPostRepository $videoPostRepo, int  $nbVue, $precision = 3, Request $request)
    {
        ...
        if ($nbVue < 1000000) {
            ...
            // At least a billion
            $n_format = number_format($nbVue/ 1000000000, $precision) . 'B';
        }
