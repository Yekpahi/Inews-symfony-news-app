...
class MainController extends AbstractController
{
     ...
     */
    public function details($slug, VideoPost $nbVue, VideoPostRepository $videoPostRepo, Request $request)
    {
        ...
        $em->flush();
        if ($nbVue >= 1E9) {
            return round($nbVue/ 1E9, 2).'b';
        } else if ($nbVue >= 1E6) {
            return round($nbVue/ 1E6, 2).'m';
        } else if ($nbVue >= 1E3) {
            return round($nbVue/ 1E3, 2).'k';
        }
        return $nbVue;
