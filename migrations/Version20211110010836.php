 ...
 */
final class Version20211110010836 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE videoPost (id INT AUTO_INCREMENT NOT NULL, users_id INT NOT NULL, categories_id INT NOT NULL, title VARCHAR(255) NOT NULL, path VARCHAR(255) DEFAULT NULL, duration INT NOT NULL, slug VARCHAR(255) NOT NULL, description VARCHAR(255) NOT NULL, content LONGTEXT DEFAULT NULL, created_at DATETIME NOT NULL, active TINYINT(1) NOT NULL, statut VARCHAR(1) DEFAULT NULL, INDEX IDX_4D4A1F4D67B3B43D (users_id), INDEX IDX_4D4A1F4DA21214B7 (categories_id), FULLTEXT INDEX IDX_4D4A1F4D2B36786BFEC530A96DE44026 (title, content, description), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
